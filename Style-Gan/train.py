...
if 1:
    ...
    # Dataset.
    desc += '-custom';     dataset = EasyDict(tfrecord_dir='smalls', resolution=100);              train.mirror_augment = False
    ...
    #desc += '-car';      dataset = EasyDict(tfrecord_dir='lsun-car-512x384');     train.mirror_augment = False d
